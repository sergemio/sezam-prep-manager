...
function updateTodoList() {
    ...
    const allActionableDone = actionableItems.length === 0;
...
// Shared slider functions (computeSliderConfig + createTouchSlider)
// live in slider.js — loaded before this script in index.html.
